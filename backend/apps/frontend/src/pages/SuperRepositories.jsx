...
const SuperRepositories = () => {
    ...
    // Fetch namespaces for superusers
    const fetchSuperNamespaces = async () => {
        try {
    ...
    const {
        ...
        handleImportClick
    } = useRepositoryManagement('/api/super/repos', fetchSuperNamespaces);

    // Role-specific: Super user can delete directly
